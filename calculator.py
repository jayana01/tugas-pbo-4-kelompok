...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(338, 557)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../Downloads/th (1).jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}\n"
"")
        self.push_plus.setIconSize(QtCore.QSize(36, 28))
